...
const INSTAGRAM_URL = 'https://www.instagram.com/inaudivel_por_favor/';
const WHATSAPP_URL = 'https://wa.me/554896196699';
    ...
    <footer className="footer">
      <div className="footer-top">
        <div className="footer-section">
          <span className="footer-section-title">Redes Sociais</span>
        ...
        <div className="footer-section">
          <span className="footer-section-title">Contato</span>
          <p
            className="footer-email"
            role="note"
            aria-label={`E-mail ${EMAIL} — apenas informativo, não é um link`}
          >
            {EMAIL}
          </p>
        </div>
      ...
      <div className="footer-hdivider" aria-hidden="true" />
