...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        <picture>
          <source media="(max-width: 768px)" srcSet={`${import.meta.env.BASE_URL}img/banners/banner_mobile.png`} />
          <img src={`${import.meta.env.BASE_URL}img/banners/banner_desktop.png`} alt="Anuncie Aqui" />
        </picture>
      </div>
